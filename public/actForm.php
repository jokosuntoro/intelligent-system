...
$classifier->train($dataTrain, $dataClass);


$pred1 = $classifier->predict([(int)$clump,(int)$UoCSize,(int)$UoCShape,(int)$marginal,(int)$epithelial,(int)$bareNuclei,(int)$blandChromatin,(int)$normalNucleoli,(int)$mitoses]);
